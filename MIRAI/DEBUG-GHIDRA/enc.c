...
// WARNING! conflicting data type names: /stdint.h/uint32_t - /DWARF/stdint-uintn.h/uint32_t
...

{
  ...
  if (iVar2 == 0) {
    ...
    iVar2 = strcmp(args[1],"ip");
    if (iVar2 == 0) {
      data = calloc(1,4);
      iVar3 = inet_addr(args[2]);
      *(in_addr_t *)data = iVar3;
      len = 4;
    }
    else {
      iVar2 = strcmp(args[1],"uint32");
      if (iVar2 == 0) {
        data = calloc(1,4);
        uVar4 = atoi(args[2]);
        uVar4 = htonl(uVar4);
        *(uint32_t *)data = uVar4;
        ...
        if (iVar2 == 0) {
          ...
          *(uint16_t *)data = uVar1;
          ...
          iVar2 = strcmp(args[1],"uint8");
          if (iVar2 == 0) {
            data = calloc(1,1);
            iVar2 = atoi(args[2]);
            *(char *)data = (char)iVar2;
            len = 1;
          }
          else {
            iVar2 = strcmp(args[1],"bool");
            if (iVar2 != 0) {
              printf("Unknown data type `%s`!\n",args[1]);
              return -1;
            }
            data = calloc(1,1);
            iVar2 = strcmp(args[2],"false");
            if (iVar2 == 0) {
              *(undefined *)data = 0;
            }
            else {
              iVar2 = strcmp(args[2],"true");
              if (iVar2 != 0) {
  ...
  pvVar6 = x(data,len);
  for (i = 0; i < len; i = i + 1) {
    printf("\\x%02X",(ulong)*(byte *)((long)pvVar6 + (long)i));
  }
  putchar(10);
  return 0;
}
...

{
  ...
  pvVar5 = malloc((long)len);
  bVar4 = (byte)table_key;
  uVar1 = table_key >> 8;
  uVar2 = table_key >> 0x10;
  uVar3 = table_key >> 0x18;
  for (i = 0; i < len; i = i + 1) {
    *(byte *)((long)i + (long)pvVar5) =
         *(byte *)((long)_buf + (long)i) ^ bVar4 ^ (byte)uVar1 ^ (byte)uVar2 ^ (byte)uVar3;
  }
  return pvVar5;
}
